...
;    [...eachth].forEach(e => e.setAttribute("class","js-tooltip"))
    eachth[OPDATE].setAttribute("help",
`คอลัมน์ Date - คลิกเลือกเคส
 ...
 การเปลี่ยนวันผ่าตัด ทำได้ 2 วิธี
    ...
    eachth[OPROOM].setAttribute("help",
...
ลบห้องผ่าตัด ใช้เลข 0`)
    eachth[OPTIME].setAttribute("help",
...
เปลี่ยนเวลา
   ...
   - ใช้ล้อหมุนเมาส์
ลบเวลา ใช้เลข 00.00`)
    eachth[CASENUM].setAttribute("help",
